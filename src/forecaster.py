...
forecast["predicted_index"] = np.round(predictions, 2)
forecast["forecast_index"] = np.round(predictions, 2)
forecast["actual_index"] = np.round(forecast["airfare_index"], 2)
forecast["lower_bound"] = np.round(predictions - 1.96 * rmse, 2)
forecast["upper_bound"] = np.round(predictions + 1.96 * rmse, 2)
